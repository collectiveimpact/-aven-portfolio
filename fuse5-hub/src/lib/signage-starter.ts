...
const IMG = {
  ...
  fire: "https://images.unsplash.com/photo-1582560475093-ba66accbc424?w=1600&q=70",
...
export const SIGNAGE_TEMPLATES: SignageTemplate[] = [
  ...
  { id: "sg-pest", name: "Pest Inspections & Treatment", category: "Operations & Waste",
    input: { orgName: "WoodGreen", category: "Operations pest", headline: "Pest Inspections and Treatment", dateText: "January 25", timeText: "9am – 5pm", secondary: "害虫防治活动通知", categoryLabel: "Regular maintenance / Mice", layout: "split" } },
  { id: "sg-water", name: "Water Shut-Off", category: "Operations & Waste",
    input: { orgName: "WoodGreen", category: "Operations water", headline: "Water Shut-Off", dateText: "Saturday, July 12", timeText: "9am – 12pm", subhead: "Please store water in advance", secondary: "停水通知 — 请提前储水", layout: "split" } },
